...
export default function RsvpForm({ PropfetchData }) {
  ...
  space-y-6"
    >
      ...
      <div>
        <label data-aos="fade-up" data-aos-delay="300"  className="mb-2 block font-serif font-semibold text-[#D4A017]">
          Nama
        </label>
      ...
      <div>
        <label data-aos="fade-right" data-aos-delay="300"  className="mb-2 block font-semibold text-[#D4A017] font-serif">
          Ucapan & Doa
        </label>
      ...
      <div>
        <label data-aos="fade-right" data-aos-delay="300"  className="mb-3 block font-serif font-semibold text-[#D4A017]">
          Kehadiran
        </label>
